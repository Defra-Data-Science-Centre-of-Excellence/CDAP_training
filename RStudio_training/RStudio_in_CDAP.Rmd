...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/User guides/image1.jpg)
 

In the table that appears, click on RStudio. 


![](C:/Users/m1007135/OneDrive - Defra/CDAP training/User guides/image2.jpg)
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/User guides/image3.jpg)
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/User guides/image4.jpg)
...
To access the data held within CDAP, enter ```setwd("/dbfs")```. This will give you access to the Databricks File Store (DBFS), where the data are held.

into the console. Under the files tab (usually on the bottom right), you should now see the folders that contain the data: 
