...
When the runtime of Databricks is updatedthat is used in CDAP, so will the list and versions of R packages.   
...
Please do not use this option for data, but save it into your folder in the lab zone instead.   