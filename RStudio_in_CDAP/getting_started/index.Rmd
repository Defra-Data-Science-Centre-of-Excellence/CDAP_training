---
title: "Working with RStudio in the DASH Platform"
output:
  html_document:
    toc: yes
    toc_float: true
...
```{r, echo = FALSE, out.width = '75%', fig.alt = "RStudio on the DASH Platform with logging out buttons highlighted on the top right"}
...
```{r, echo = FALSE, out.width = '50%', fig.alt = "View of RStudio cluster on the DASH Platform with databricks runtime highlighted on the bottom"}
...
```{r, echo = FALSE, out.width = '75%', fig.alt = "RStudio workspace on the DASH Platform, with files section highlighted"}
...
Therefore you need to back up your work on a regular basis. The recommended way is to do so via [GitHub](https://defra-data-science-centre-of-excellence.github.io/CDAP_training/RStudio_in_CDAP/git_and_github/).  
...
![](images/DownloadingFiles.mp4){#id .class width=75%}
