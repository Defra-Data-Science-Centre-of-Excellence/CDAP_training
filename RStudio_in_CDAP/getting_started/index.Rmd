...
You can also find the file paths from within CDAP. You need the file paths to load data into RStudio from within CDAP.  
...
Since you haven't specified a particular place for the figure to be saved to, it should appear on the right of your RStudio screen under Files. You can also export files by ticking the box left to the file name, then More > Export..., and the file will be downloaded into your Downloads folder on your local machine.
