...
2. In the RStudio menu, select *Tools > Shell…* and the shell should open.  

3. Type in ```Which git```, which should return ```usr/bin/git``` (this means that you are definitely using the correct shell)  
...
This is everything we need to do in the shell, so return to RStudio and run the rest of the code in this document in the console.  

5. We will use a package called usethis for much of the following, which is to ensure that your local RStudio is connected to GitHub. First install the package: ```install.packages("usethis")```  
...
8. Now to check that this has worked, type ```credentials::set_github_pat()``` which should come up with this: `If prompted for GitHub credentials, enter your PAT in the password field`  

### Adding your GitHub repo to RStudio  

9. We will now test if your local RStudio is properly connected to GitHub. Create a new repository in GitHub to test this out, by going to your GitHub homepage, then on the left under recent repositories, click the green button that says New.  

![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image1.png)  
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image2.png)  
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image3.png)   
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image4.png)  
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image5.png)  
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image6.png)
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image7.png)
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image8.png)
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image9.png)
...
![](C:/Users/m1007135/OneDrive - Defra/CDAP training/CDAP_training/rstudio_in_cdap/git_and_github/images/image10.png)

18. If this has worked, then you are all set up to work with GitHub! You can delete the repository you created on GitHub and on your local machine.  
