...
5. We will use a package called usethis for much of the following, which is to ensure that your CDAP RStudio is connected to GitHub. First install the package: ```install.packages("usethis")```  
...
8. Now to check that this has worked, type ```usethis::git_sitrep()``` which should come up with lots of information and hopefully no errors.    
