...
8. Now to check that this has worked, type ```usethis::git_sitrep()``` which should come up with lots of information and hopefully no errors, and some information under personal access token where you can check if something has been saved. Now is a good time to restart RStudio to ensure everything is working as it should.     
