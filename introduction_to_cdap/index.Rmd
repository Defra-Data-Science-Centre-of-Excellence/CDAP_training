...
To access CDAP, go to this link to the [PROD environment](https://adb-7480336463633201.1.azuredatabricks.net/?o=7480336463633201#) which all users have access to. If you have access to other environments, you can access those from the same link.  
...
It is possible to run R in Databricks notebooks, but you can also use an online version of RStudio through CDAP. We have added training materials on accessing RStudio in CDAP, working with data, and connecting RStudio to git and GitHub. Go back to the main site to access them.