...
To access CDAP, go to this link to the [PROD environment](https://adb-7393756451346106.6.azuredatabricks.net/) which all users have access to. If you have access to other environments, you can access those from the same link. 
...
Most users will have access to the PROD environment only, but for some purposes access to other environments can be granted. For more information on the different environments, see the CDAP playbook.
...
The clusters that are available on CDAP are detailed in the CDAP Playbook.  
