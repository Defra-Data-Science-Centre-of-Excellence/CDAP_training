...
[DASH Init scripts](https://github.com/Defra-Data-Science-Centre-of-Excellence/init-scripts). General information about init scripts can be found in [What are init scripts?](https://docs.databricks.com/en/init-scripts/index.html).
